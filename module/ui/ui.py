...
class Controller(QMainWindow, form_class):
    ...
    def get_ui(self):
        ...
        self.button_widget_list = [self.convert_button, self.extract_button, self.filter_button, self.output_button,
                                   self.all_process_button]
    ...
    def connect_function_and_widget(self):
        ...
        self.button_widget_list[0].clicked.connect(
            lambda: self.convert_process(root_och, root_csv, self.process_clicked_list))
        self.button_widget_list[1].clicked.connect(
            lambda: self.extract_process(root_csv, root_summarized, path_all_field_info, root_for_field,
                                         self.process_clicked_list))
        self.button_widget_list[2].clicked.connect(
            lambda: self.filter_process(root_summarized, root_for_field, root_for_noise,
                                        root_csv, root_for_editted_file, self.process_clicked_list))
        self.button_widget_list[3].clicked.connect(
            lambda: self.convert_process(root_for_editted_file, root_for_result_och, self.process_clicked_list,
                                         True, True, False))
        ...
        arg_list = [root_gp, root_och, root_csv, self.process_clicked_list,
                    ...
                    root_summarized, root_for_field, root_for_noise, root_csv, root_for_editted_file,
                    self.process_clicked_list,
    ...
    def convert_process(self, path_root_folder_gp_input, path_root_folder_och_input, path_root_folder_output,
                        name_folder_list, is_gp_to_och=True, is_och_to_csv=True, is_csv_to_och=False):
        '''
    ...
    def extract_process(self, path_root_folder_input, path_root_folder_for_min_average, path_field_info,
                        path_root_folder_for_field, name_folder_list):
        '''
        ...
        for name_folder in name_folder_list:
            ...
            object_find_field.find_field_csv_folder(path_csv_folder + "/", path_field_info,
                                                    path_output_folder_for_field + "/")
    ...
    def filter_process(self, path_root_folder_summarized_data, path_read_field_folder, path_root_folder_noise,
        ...
        for name_folder in name_folder_list:
            ...
            object_noise.find_noise_in_data(path_root_folder_summarized_data, path_read_field_folder,
                                            path_root_folder_noise, name_folder)
            ...
            object_edit.cut_error(path_root_folder_to_cut, path_root_folder_noise, path_root_folder_for_eddited_files,
                                  name_folder)
    ...
    def all_process(self, arg_list):
        ...
        self.filter_process(arg_list[9], arg_list[10], arg_list[11], arg_list[12], arg_list[13],
                            self.process_clicked_list)
